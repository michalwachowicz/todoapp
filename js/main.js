...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _TagEditPopup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TagEditPopup */ "./src/js/components/tag/TagEditPopup.js");
...
const TagContextMenu = (() => {
  ...
  editBtn.addEventListener('click', () => {
    _TagEditPopup__WEBPACK_IMPORTED_MODULE_0__["default"].generatePopup(tagId)
    hide()
  })
...
/* harmony import */ var _EmptyMessage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../EmptyMessage */ "./src/js/components/EmptyMessage.js");
/* harmony import */ var _icons_AddIcon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../icons/AddIcon */ "./src/js/components/icons/AddIcon.js");
/* harmony import */ var _icons_MoreIcon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../icons/MoreIcon */ "./src/js/components/icons/MoreIcon.js");
/* harmony import */ var _tag_TagContextMenu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../tag/TagContextMenu */ "./src/js/components/tag/TagContextMenu.js");
/* harmony import */ var _NewTaskForm__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./NewTaskForm */ "./src/js/components/task/NewTaskForm.js");
/* harmony import */ var _Task__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Task */ "./src/js/components/task/Task.js");
...
const TasksView = (() => {
  ...
  const generateTasks = (title, tagId, tasks) => {
    ...
    if (tagId > -1) {
      ...
      const moreIcon = (0,_icons_MoreIcon__WEBPACK_IMPORTED_MODULE_4__["default"])('tasks-view__icon--more')
      moreIcon.addEventListener('click', (e) => {
        _tag_TagContextMenu__WEBPACK_IMPORTED_MODULE_5__["default"].generateMenu(tagId, e.clientX, e.clientY)
      })
      const tag = _data_tags__WEBPACK_IMPORTED_MODULE_0__["default"].getTagById(tagId)
    ...
    if (tasks.length > 0) {
      ...
      for (let task of tasks) {
        const taskItem = (0,_Task__WEBPACK_IMPORTED_MODULE_7__["default"])(task)
      ...
      element.appendChild(
        (0,_EmptyMessage__WEBPACK_IMPORTED_MODULE_2__["default"])(
    ...
    btn.addEventListener('click', () => _NewTaskForm__WEBPACK_IMPORTED_MODULE_6__["default"].updateForm(null))

    const btnTitle = document.createElement('h3')
    btnTitle.className = 'tasks-view__btn__title'
    btnTitle.textContent = 'Add new task'

    btn.appendChild((0,_icons_AddIcon__WEBPACK_IMPORTED_MODULE_3__["default"])('tasks-view__btn__icon'))
...
/* harmony import */ var _contentGenerator__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./contentGenerator */ "./src/js/contentGenerator.js");
