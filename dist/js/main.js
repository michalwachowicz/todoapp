...
const NewTaskForm = (() => {
  ...
  form.addEventListener('submit', (e) => {
    ...
    const taskObj = {
      id: task && task.id ? task.id : _data_tasks__WEBPACK_IMPORTED_MODULE_1__["default"].getLastId(),
      title: title.value,
...
/* harmony import */ var _data_tags__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../data/tags */ "./src/js/data/tags.js");
...
const Task = ({ title, description, dueDate, priorityId, tagId, done }) => {
  ...
  if (tagId > -1) {
    const tag = _data_tags__WEBPACK_IMPORTED_MODULE_3__["default"].getTagById(tagId)
  ...
  if (dueDate) {
    ...
    date.textContent =
      dueDate.getDate() == currentDate.getDate()
        ? 'Today'
        : (0,date_fns_formatDistance__WEBPACK_IMPORTED_MODULE_4__["default"])(dueDate, currentDate, { addSuffix: true })
